 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3._2001._04.xmlenc.impl.TransformsTypeImpl#getTransform <em>Transform</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransformsTypeImpl extends MinimalEObjectImpl.Container implements TransformsType {
	...
	protected EClass eStaticClass() {
		return XmlencPackage.Literals.TRANSFORMS_TYPE;
	}
	...
	public EList<TransformType> getTransform() {
		if (transform == null) {
			transform = new EObjectContainmentEList<TransformType>(TransformType.class, this, XmlencPackage.TRANSFORMS_TYPE__TRANSFORM);
		}
		return transform;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XmlencPackage.TRANSFORMS_TYPE__TRANSFORM:
