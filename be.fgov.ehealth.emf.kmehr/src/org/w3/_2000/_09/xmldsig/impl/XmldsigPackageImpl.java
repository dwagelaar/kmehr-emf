...
public class XmldsigPackageImpl extends EPackageImpl implements XmldsigPackage {
	...
	public static XmldsigPackage init() {
		...
		Object registeredXmldsigPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		XmldsigPackageImpl theXmldsigPackage = registeredXmldsigPackage instanceof XmldsigPackageImpl ? (XmldsigPackageImpl)registeredXmldsigPackage : new XmldsigPackageImpl();
