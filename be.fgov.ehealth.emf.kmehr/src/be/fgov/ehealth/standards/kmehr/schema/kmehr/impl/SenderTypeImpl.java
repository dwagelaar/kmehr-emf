 ...
 * </p>
 * <ul>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.schema.kmehr.impl.SenderTypeImpl#getHcparty <em>Hcparty</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SenderTypeImpl extends MinimalEObjectImpl.Container implements SenderType {
	...
	protected EClass eStaticClass() {
		return KmehrPackage.Literals.SENDER_TYPE;
	}
	...
	public EList<HcpartyType> getHcparty() {
		if (hcparty == null) {
			hcparty = new EObjectContainmentEList<HcpartyType>(HcpartyType.class, this, KmehrPackage.SENDER_TYPE__HCPARTY);
		}
		return hcparty;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KmehrPackage.SENDER_TYPE__HCPARTY:
