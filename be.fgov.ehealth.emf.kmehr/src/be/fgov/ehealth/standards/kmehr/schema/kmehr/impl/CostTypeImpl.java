 ...
 * </p>
 * <ul>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.schema.kmehr.impl.CostTypeImpl#getDecimal <em>Decimal</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.schema.kmehr.impl.CostTypeImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CostTypeImpl extends MinimalEObjectImpl.Container implements CostType {
	...
	protected EClass eStaticClass() {
		return KmehrPackage.Literals.COST_TYPE;
	}
	...
	public void setDecimal(BigDecimal newDecimal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KmehrPackage.COST_TYPE__DECIMAL, oldDecimal, decimal));
	}
	...
	public NotificationChain basicSetUnit(UnitType newUnit, NotificationChain msgs) {
		...
		unit = newUnit;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KmehrPackage.COST_TYPE__UNIT, oldUnit, newUnit);
	...
	public void setUnit(UnitType newUnit) {
		if (newUnit != unit) {
			...
			if (unit != null)
				msgs = ((InternalEObject)unit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KmehrPackage.COST_TYPE__UNIT, null, msgs);
			if (newUnit != null)
				msgs = ((InternalEObject)newUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KmehrPackage.COST_TYPE__UNIT, null, msgs);
			msgs = basicSetUnit(newUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KmehrPackage.COST_TYPE__UNIT, newUnit, newUnit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KmehrPackage.COST_TYPE__UNIT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KmehrPackage.COST_TYPE__DECIMAL:
				return getDecimal();
			case KmehrPackage.COST_TYPE__UNIT:
				return getUnit();
		}
