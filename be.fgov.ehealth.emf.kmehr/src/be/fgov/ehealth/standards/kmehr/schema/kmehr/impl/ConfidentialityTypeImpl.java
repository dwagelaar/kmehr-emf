 ...
 * </p>
 * <ul>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.schema.kmehr.impl.ConfidentialityTypeImpl#getHcparty <em>Hcparty</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfidentialityTypeImpl extends MinimalEObjectImpl.Container implements ConfidentialityType {
	/**
	...
	protected EClass eStaticClass() {
		return KmehrPackage.Literals.CONFIDENTIALITY_TYPE;
	}
	...
	public EList<HcpartyType> getHcparty() {
		if (hcparty == null) {
			hcparty = new EObjectContainmentEList<HcpartyType>(HcpartyType.class, this, KmehrPackage.CONFIDENTIALITY_TYPE__HCPARTY);
		}
		return hcparty;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KmehrPackage.CONFIDENTIALITY_TYPE__HCPARTY:
