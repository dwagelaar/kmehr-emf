 ...
 * </p>
 * <ul>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.LOCALImpl#getValue <em>Value</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.LOCALImpl#getDN <em>DN</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.LOCALImpl#getL <em>L</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.LOCALImpl#getS <em>S</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.LOCALImpl#getSL <em>SL</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.LOCALImpl#getSV <em>SV</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LOCALImpl extends MinimalEObjectImpl.Container implements LOCAL {
	 ...
	 * @ordered
	 */
	protected static final String S_EDEFAULT = "LOCAL";
	...
	protected EClass eStaticClass() {
		return CdPackage.eINSTANCE.getLOCAL();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.LOCAL__VALUE, oldValue, value));
	}
	...
	public void setDN(String newDN) {
		...
		dN = newDN;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.LOCAL__DN, oldDN, dN));
	}
	...
	public void setL(String newL) {
		...
		l = newL;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.LOCAL__L, oldL, l));
	}
	...
	public void setS(String newS) {
		...
		sESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.LOCAL__S, oldS, s, !oldSESet));
	}
	...
	public void unsetS() {
		...
		sESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CdPackage.LOCAL__S, oldS, S_EDEFAULT, oldSESet));
	}
	...
	public void setSL(String newSL) {
		...
		sL = newSL;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.LOCAL__SL, oldSL, sL));
	}
	...
	public void setSV(String newSV) {
		...
		sV = newSV;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.LOCAL__SV, oldSV, sV));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CdPackage.LOCAL__VALUE:
				return getValue();
			case CdPackage.LOCAL__DN:
				return getDN();
			case CdPackage.LOCAL__L:
				return getL();
			case CdPackage.LOCAL__S:
				return getS();
			case CdPackage.LOCAL__SL:
				return getSL();
			case CdPackage.LOCAL__SV:
				return getSV();
		}
