...
import be.fgov.ehealth.standards.kmehr.cd.cd.EMPTY;
 ...
 * </p>
 * <ul>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.EMPTYImpl#getValue <em>Value</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.EMPTYImpl#getDN <em>DN</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.EMPTYImpl#getL <em>L</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.EMPTYImpl#getS <em>S</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.EMPTYImpl#getSL <em>SL</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.EMPTYImpl#getSV <em>SV</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EMPTYImpl extends MinimalEObjectImpl.Container implements EMPTY {
	/**
	...
	protected EClass eStaticClass() {
		return CdPackage.eINSTANCE.getEMPTY();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.EMPTY__VALUE, oldValue, value));
	}
	...
	public void setDN(String newDN) {
		...
		dN = newDN;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.EMPTY__DN, oldDN, dN));
	}
	...
	public void setL(String newL) {
		...
		l = newL;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.EMPTY__L, oldL, l));
	}
	...
	public void setS(String newS) {
		...
		s = newS;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.EMPTY__S, oldS, s));
	}
	...
	public void setSL(String newSL) {
		...
		sL = newSL;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.EMPTY__SL, oldSL, sL));
	}
	...
	public void setSV(String newSV) {
		...
		sV = newSV;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.EMPTY__SV, oldSV, sV));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CdPackage.EMPTY__VALUE:
				return getValue();
			case CdPackage.EMPTY__DN:
				return getDN();
			case CdPackage.EMPTY__L:
				return getL();
			case CdPackage.EMPTY__S:
				return getS();
			case CdPackage.EMPTY__SL:
				return getSL();
			case CdPackage.EMPTY__SV:
				return getSV();
		}
