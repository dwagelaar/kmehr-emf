...
import be.fgov.ehealth.standards.kmehr.cd.cd.ICD;
 ...
 * </p>
 * <ul>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.ICDImpl#getValue <em>Value</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.ICDImpl#getDN <em>DN</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.ICDImpl#getL <em>L</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.ICDImpl#getS <em>S</em>}</li>
 *   <li>{@link be.fgov.ehealth.standards.kmehr.cd.cd.impl.ICDImpl#getSV <em>SV</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ICDImpl extends MinimalEObjectImpl.Container implements ICD {
	 ...
	 * @ordered
	 */
	protected static final String S_EDEFAULT = "ICD";
	...
	protected EClass eStaticClass() {
		return CdPackage.eINSTANCE.getICD();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.ICD__VALUE, oldValue, value));
	}
	...
	public void setDN(String newDN) {
		...
		dN = newDN;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.ICD__DN, oldDN, dN));
	}
	...
	public void setL(String newL) {
		...
		lESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.ICD__L, oldL, l, !oldLESet));
	}
	...
	public void unsetL() {
		...
		lESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CdPackage.ICD__L, oldL, L_EDEFAULT, oldLESet));
	}
	...
	public void setS(String newS) {
		...
		sESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.ICD__S, oldS, s, !oldSESet));
	}
	...
	public void unsetS() {
		...
		sESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CdPackage.ICD__S, oldS, S_EDEFAULT, oldSESet));
	}
	...
	public void setSV(String newSV) {
		...
		sV = newSV;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CdPackage.ICD__SV, oldSV, sV));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CdPackage.ICD__VALUE:
				return getValue();
			case CdPackage.ICD__DN:
				return getDN();
			case CdPackage.ICD__L:
				return getL();
			case CdPackage.ICD__S:
				return getS();
			case CdPackage.ICD__SV:
				return getSV();
		}
