...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>CDMKGORIGI Nvalues</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see be.fgov.ehealth.standards.kmehr.cd.cd.CdPackage#getCDMKGORIGINvalues()
 * @model extendedMetaData="name='CD-MKG-ORIGINvalues'"
 * @generated
 */
public enum CDMKGORIGINvalues implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>CDMKGORIGI Nvalues</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final CDMKGORIGINvalues[] VALUES_ARRAY =
		new CDMKGORIGINvalues[] {
			_0,
			_1,
			_2,
			_3,
	...
	/**
	 * A public read-only list of all the '<em><b>CDMKGORIGI Nvalues</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<CDMKGORIGINvalues> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>CDMKGORIGI Nvalues</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CDMKGORIGINvalues get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CDMKGORIGINvalues result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>CDMKGORIGI Nvalues</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static CDMKGORIGINvalues getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CDMKGORIGINvalues result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>CDMKGORIGI Nvalues</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CDMKGORIGINvalues get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private CDMKGORIGINvalues(int value, String name, String literal) {
		this.value = value;
		this.name = name;
